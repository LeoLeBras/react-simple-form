...
// validator prop
export function getFieldErrors (field: FormField, errorMessages: ErrorMessages): FieldErrors {
...
// msg : "succes" or "error"
export const getFormStatus = (form: FormState): 'success' | 'error' => (
...
export const getFormValues = (form: FormState): {[name: string]: string} => (
